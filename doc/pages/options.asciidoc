...
*ui_options* `str-to-str-map`::
    ...
    interface implementation. The Terminal UI supports the following options:
        ...
        *terminal_synchronized*:::
            ...
            if unsynchronized (defaults to auto-detection)
        ...
        *terminal_clipboard*:::
            if *yes* or *true*, use the OSC 52 escape code to synchronize the
            system clipboard with the *'* register (defaults to auto-detection)
